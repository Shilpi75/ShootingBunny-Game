...
#The first variable keeps track of the players accuracy (list of the number of shots fired and 
#the number of badgers hit) and the second array tracks all the arrows.
acc=[0,0]
arrows=[]
